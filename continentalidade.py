...
#            limits[1] += 24
        ...
        for i in range(97):
            L += [i]
        plt.errorbar(L, meanList, yerr = deviationList, ecolor = 'red', ls='dotted') #label = 'Latitude 14')
